...
const ControlPanel = () => {
  ...
  useEffect(() => {
    axios.get('https://accurate-spontaneity-production.up.railway.app/usuarios/listar')
      .then(response => {
  ...
  const handleRoleToggle = (id, esAdministrador) => {
    axios.put(`https://accurate-spontaneity-production.up.railway.app/usuarios/cambiar-rol/${id}`, null, {
