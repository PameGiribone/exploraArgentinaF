...
const Home = () => {
  ...
  useEffect(() => {
    if (userActive) {
      ...
      if (userId) {
        axios
          .get(`https://accurate-spontaneity-production.up.railway.app/favoritos/listarFavoritos/${userId}`)
          .then((response) => {
  ...
  useEffect(() => {
    if (selectedDate) {
      axios
        .get(
          `https://accurate-spontaneity-production.up.railway.app/reservar/productosPorFecha/${
  ...
  const handleFavoriteToggle = async (tourId) => {
    ...
    try {
      if (isFavorite) {
        ...
        await axios.post('https://accurate-spontaneity-production.up.railway.app/favoritos/agregarFavorito', {
          usuarioId: userId,
          productoId: tourId,
        });
